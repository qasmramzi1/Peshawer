...
class Setting_Saqfsanawi extends StatefulWidget {
  const Setting_Saqfsanawi({Key? key}) : super(key: key);

  @override
  _Setting_SaqfsanawiState createState() => _Setting_SaqfsanawiState();
}

class _Setting_SaqfsanawiState extends State<Setting_Saqfsanawi> {
            ...
            child: StreamBuilder<QuerySnapshot>(
                            stream: (name != 'FollowUP' && name != 'FollowUP')
                                ...
                                FirebaseFirestore.instance
                                    ...
                                    .where('Query', isEqualTo: 'SaqfSanawi') //
